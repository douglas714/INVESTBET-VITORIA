...
console.log(`✓ Total de jogos analisados: ${mockGames.length}`);
console.log(`✓ Jogos aprovados: ${approvedCount}`);
console.log(`✓ Taxa de aprovação: ${(approvedCount / mockGames.length * 100).toFixed(0)}%\n`);
